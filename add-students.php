...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Mat_No</label>
<div class="col-sm-10">
<input type="text" name="rollid" class="form-control" id="rollid" maxlength="19" required="required" autocomplete="off" placeholder="plasu/2016/fns/0011">
</div>
</div>
