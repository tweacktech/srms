...
<p><b>Student Roll Id :</b> <?php echo htmlentities($mat=$row->RollId);?>
...
foreach($results as $result){
  ...
  if ($totalmarks >= 70) {
    $grade = "A";
} elseif ($totalmarks >= 69) {
    $grade = "B";
} elseif ($totalmarks >= 59) {
    $grade = "C";
} elseif ($totalmarks >= 49) {
    $grade = "D";
} else {
    $grade = "F";
}
...
<tr>
                                                <th scope="row" colspan="2">Download Result</th>           
                                                            <td><b><a href="#"onclick="downloadPDF()">Download </a> </b></td>
                                                            <td><a href="trans.php?id=<?php echo htmlentities($mat)?> ">View Transcript</a></td>
                                                             </tr>
